<template>
  <div class="rechargeRecord common-css">
    <div class="wrapper">
      <!--    导航栏-->
      ...
      <el-container class="head row-bg table-short" type="flex">
        <el-container>
          <el-form :inline="true" :model="search" class="demo-form-inline" ref="search">
            ...
            <el-form-item prop="appTime" label="充值时间:">
              <el-date-picker
                v-model="search.appTime"
                size="mini"
                type="daterange"
            ...
            <el-form-item prop="shareholderState">
              <el-select v-model="search.shareholderState" placeholder="充值类型" value="" size="mini" :span="6">
                <el-option
            ...
            <el-form-item prop="shareholderState">
              <el-select v-model="search.shareholderState" placeholder="充值状态" value="" size="mini" :span="6">
                <el-option
                  v-for="item in options"
                  :key="item.value"
                  :label="item.label"
            ...
            <el-form-item prop="keywords">
              <el-input placeholder="关键词搜索" size="mini" v-model="search.keywords" @keyup.enter.native="handelSearch"></el-input>
            </el-form-item>
            <el-form-item>
